      ...
      <div className="container max-w-[1200px] mx-auto h-full px-4">
        <div className="flex items-center justify-between md:justify-center h-full">
          ...
          <div className="hidden md:flex items-center">
            ...
            <Link
              href="/mundial"
              className="typography-menu ml-4 px-5 py-1.5 bg-[#3CB7FF] text-white text-sm font-semibold rounded-full hover:bg-[#3CB7FF]/90 transition-all shadow-lg shadow-[#3CB7FF]/20"
            >
              SEGUI EL MUNDIAL
            </Link>
          </div>
      ...
      >
        <div className="flex flex-col h-full pt-24 px-8 gap-2">
          ...
          <Link
            ...
            className={cn(
              "typography-menu mt-10 text-center py-5 bg-[#3CB7FF] rounded-2xl text-white text-2xl font-semibold shadow-xl shadow-[#3CB7FF]/20 transition-all duration-500",
